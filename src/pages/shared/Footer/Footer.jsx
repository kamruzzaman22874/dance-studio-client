				...
				<div className='flex flex-col space-y-4'>
					...
					<div className='flex flex-col space-y-10 text-sm dark:text-gray-400'>
						<p className='py-6'>
							...
							way of taking care your needs. The barrage of shortcodes that
							works in the pages, makes it the better choice for your business.
						</p>
				...
				<div className='flex flex-col space-y-4 text-lg'>
					...
					<div className='flex flex-col space-y-2 text-sm dark:text-gray-400'>
						<a
							...
							rel='noopener noreferrer'
							href='#'>
							<FaMusic /> Hip Hop Dance : 07:00 – 21:00
						</a>
						<a
							className='flex items-center gap-3'
							rel='noopener noreferrer'
							href='#'>
							<FaMusic /> Ballet : 09:00 – 21:00
						</a>
						<a
							className='flex items-center gap-3'
							rel='noopener noreferrer'
							href='#'>
							<FaMusic /> Break Dance : 18:00 – 24:00
						</a>
						<a
							className='flex items-center gap-3'
							rel='noopener noreferrer'
							href='#'>
							<FaMusic /> Salsa : 18:00 – 22:00
						</a>
						<a
							className='flex items-center gap-3'
							rel='noopener noreferrer'
							href='#'>
							<FaMusic /> Tab Dancing : 19:00 – 23:00
						</a>
						<a
							className='flex items-center gap-3'
							rel='noopener noreferrer'
							href='#'>
							<FaMusic /> Cha Cha : 20:00 – 23:00
						</a>
						<a
							className='flex items-center gap-3'
							rel='noopener noreferrer'
							href='#'>
							<FaMusic /> Corridos : 07:00 – 21:00
						</a>
					</div>
				</div>
				<div className='flex flex-col space-y-14'>
					...
					<div className='flex flex-col space-y-2 text-sm dark:text-gray-400'>
						...
						<a
							...
							rel='noopener noreferrer'
							href='#'>
							<FaMusic /> Cumbia : 09:00 – 21:00
						</a>
						<a
							className='flex items-center gap-3'
							rel='noopener noreferrer'
							href='#'>
							<FaMusic /> Duranguense : 18:00 – 24:00
						</a>
						<a
							className='flex items-center gap-3'
							rel='noopener noreferrer'
							href='#'>
							<FaMusic /> Quebradita : 18:00 – 22:00
						</a>
					</div>
				</div>
				<div className='flex flex-col space-y-4 '>
